CREATE TABLE cliente( id INT PRIMARY KEY, name VARCHAR(30) NOT NULL);

CREATE TABLE totalElements(CustomerId INT NOT NULL,
   Type VARCHAR(30),
   DATE DATE NOT NULL,
   Quantity INT NOT NULL,
   FOREIGN KEY (CustomerId) REFERENCES cliente(id));

CREATE TABLE bsc( cliente_fk INT NOT NULL,
...
CREATE TABLE bcf( bsc_cnumber INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   bcf_ident DOUBLE PRIMARY KEY,
   bcf_id INT NOT NULL,
   bcf_name VARCHAR(20),
   bcf_type VARCHAR(20) NOT NULL,
   sw_ver INT  DEFAULT 0,
   FOREIGN KEY (bsc_cnumber) REFERENCES bsc(cnumber));
...
CREATE TABLE bts (bcf_ident_fk DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   bts_ident DOUBLE PRIMARY KEY,
   bts_id INT NOT NULL,
   bts_name VARCHAR(40),
   seg_id INT,
   seg_name VARCHAR(40),
   ...
   FOREIGN KEY (bcf_ident_fk) REFERENCES bcf(bcf_ident));
   
CREATE TABLE trx (bts_ident_fk DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   trx_ident DOUBLE PRIMARY KEY,
   bts_id INT NOT NULL,
   trx_id INT NOT NULL,
   trx_mbcch VARCHAR(20),
   trx_edge_supported VARCHAR(10),
   freq INT,
   FOREIGN KEY (bts_ident_fk) REFERENCES bts(bts_ident));
...
CREATE TABLE units_bsc(id INT, 
   ...
   FOREIGN KEY(cnumber) REFERENCES bsc(cnumber));

CREATE TABLE plugin_units_bsc(id INT, 
   file_uuid VARCHAR(40) DEFAULT "-",
   type VARCHAR(15),
...
CREATE TABLE bcf_sw_version ( id INT PRIMARY KEY NOT NULL, 
   file_uuid VARCHAR(40) DEFAULT "-",
   bcf_type VARCHAR(20) NOT NULL,
   version_id VARCHAR(30) NOT NULL, 
   version_name VARCHAR(30) );

CREATE TABLE licence_bsc (fea_code INT PRIMARY KEY,
   file_uuid VARCHAR(40) DEFAULT "-",
   fea_name VARCHAR(50));

CREATE TABLE bsc_to_licence(id DOUBLE PRIMARY KEY,
   file_uuid VARCHAR(40) DEFAULT "-",
   cnumber_fk INT NOT NULL,
   fea_code_fk INT NOT NULL,
   capacity VARCHAR(10) NOT NULL,
   lk_usage VARCHAR(10) DEFAULT 'ON',
   FOREIGN KEY(cnumber_fk) REFERENCES bsc(cnumber),
   FOREIGN KEY(fea_code_fk) REFERENCES licence_bsc(fea_code));
...
CREATE TABLE bsc_lk_file(filename VARCHAR(30),
   ...
   FOREIGN KEY(targetid) REFERENCES bsc(cnumber),
   FOREIGN KEY(fea_code) REFERENCES licence_bsc(fea_code));
   
   
CREATE TABLE rnc( cliente_fk INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   rnc_id INT NOT NULL,
...
CREATE TABLE iups_rnc( rnc_cnumber INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   NetworkInd INT DEFAULT 0,
   SignPointCode INT NOT NULL,
			CNDomainVersion INT DEFAULT 0,
    FOREIGN KEY (rnc_cnumber) REFERENCES rnc(cnumber));

CREATE TABLE iucs_rnc( rnc_cnumber INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    NetworkInd INT DEFAULT 0,
    SignPointCode INT NOT NULL,
			CNDomainVersion INT DEFAULT 0,
...
CREATE TABLE iur_rnc( rnc_cnumber INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    NetworkInd INT DEFAULT 0,
    SignPointCode INT NOT NULL,
...
CREATE TABLE wbts( rnc_cnumber INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   wbts_ident DOUBLE PRIMARY KEY,
...
CREATE TABLE wbtsFtm(wbtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   ind DOUBLE PRIMARY KEY,
   id DOUBLE NOT NULL,
   locationName VARCHAR(50),
   softwareReleaseVersion VARCHAR(30),
   systemTitle VARCHAR(30),
   userLabel VARCHAR(30),
   FOREIGN KEY (wbtsInd) REFERENCES wbts(wbts_ident));

CREATE TABLE wbtsIpno(ftmInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   ind DOUBLE PRIMARY KEY,
   id DOUBLE NOT NULL,
   FOREIGN KEY (ftmInd) REFERENCES wbtsFtm(Ind));

CREATE TABLE wbtsIntp(ipnoInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    ind DOUBLE PRIMARY KEY,
    id DOUBLE NOT NULL,
    FOREIGN KEY (ipnoInd) REFERENCES wbtsIpno(Ind));

CREATE TABLE wbtsNtp(intpInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   ip VARCHAR(30) DEFAULT "-",
   FOREIGN KEY (intpInd) REFERENCES wbtsIntp(ind));

CREATE TABLE wbtsUnit(ftmInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    id INT NOT NULL,
...
CREATE TABLE wbtsHwList(wbtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    prodCode VARCHAR(50) NOT NULL,
    serNum VARCHAR(50) NOT NULL,
    FOREIGN KEY (wbtsInd) REFERENCES wbts(wbts_ident));

CREATE TABLE wbtsMRBTS( wbtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    ind DOUBLE PRIMARY KEY,
    id INT NOT NULL,
    TimeZone VARCHAR(20),
...
CREATE TABLE wbtsRmod(mrbtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    id INT NOT NULL,
    prodCode VARCHAR(50),
    serNum VARCHAR(50),
    FOREIGN KEY (mrbtsInd) REFERENCES wbtsMRBTS(ind));

CREATE TABLE wbtsSmod(mrbtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    id INT NOT NULL,
    prodCode VARCHAR(50),
    serNum VARCHAR(50),
...
CREATE TABLE unitListItem(MrBtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
...
CREATE TABLE wcel (wbts_ident_fk DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   name VARCHAR(50) DEFAULT "-",
   wcel_ident DOUBLE PRIMARY KEY,
   wcel_id INT,
   cell_id INT,
   lac INT,
   sac INT,
   ...
   dl_scc INT,
   cell_range INT,
   FOREIGN KEY (wbts_ident_fk) REFERENCES wbts(wbts_ident));
...
CREATE TABLE wbtsMODULE(wbtsHWInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    id DOUBLE NOT NULL,   
    ind DOUBLE PRIMARY KEY,
    ...
    FOREIGN KEY(wbtsHWInd) REFERENCES wbtsHW(ind));
    
    
CREATE TABLE wbtsSUBMODULE(wbtsMODULEInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    id DOUBLE NOT NULL,
    ind DOUBLE PRIMARY KEY,
    identificationCode VARCHAR(20) DEFAULT "-",
    ...
    version VARCHAR(20) DEFAULT "-",
    FOREIGN KEY(wbtsMODULEInd) REFERENCES wbtsMODULE(ind));

CREATE TABLE licence_rnc (fea_code INT PRIMARY KEY,
   file_uuid VARCHAR(40) DEFAULT "-",
   fea_name VARCHAR(50));

CREATE TABLE rnc_to_licence(id DOUBLE PRIMARY KEY,
   file_uuid VARCHAR(40) DEFAULT "-",
   cnumber_fk INT NOT NULL,
   fea_code_fk INT NOT NULL,
   lk_usage VARCHAR(10) DEFAULT '-',
   capacity VARCHAR(10) NOT NULL,
   FOREIGN KEY(cnumber_fk) REFERENCES rnc(cnumber),
   FOREIGN KEY(fea_code_fk) REFERENCES licence_rnc(fea_code));
...
CREATE TABLE rnc_lk_file(filename VARCHAR(30),
   ...
   featurename VARCHAR(200),
   fea_code INT NOT NULL,
   FOREIGN KEY(targetid) REFERENCES rnc(cnumber),
   FOREIGN KEY(fea_code) REFERENCES licence_rnc(fea_code));

CREATE TABLE units_rnc(id INT, 
   file_uuid VARCHAR(40) DEFAULT "-",
   type VARCHAR(15),
   state VARCHAR(10),
   ...
   shms INT DEFAULT -1,
   ppa INT DEFAULT -1,
   FOREIGN KEY(cnumber) REFERENCES rnc(cnumber));
...
CREATE TABLE cnl(id INT PRIMARY KEY,
   file_uuid VARCHAR(40) DEFAULT "-",
   uf VARCHAR(4) NOT NULL,
   cnl VARCHAR(6) NOT NULL,
   loc VARCHAR(40) NOT NULL);

CREATE TABLE mrbts(CustomerId INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   Name VARCHAR(30),
   Ind DOUBLE PRIMARY KEY,
   Id DOUBLE NOT NULL,
...
CREATE TABLE Rmod(mrbtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    id INT NOT NULL,
    prodCode VARCHAR(50),
    serNum VARCHAR(50),
    FOREIGN KEY (mrbtsInd) REFERENCES mrbts(ind));

CREATE TABLE Smod(mrbtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    id INT NOT NULL,
    prodCode VARCHAR(50),
    serNum VARCHAR(50),
...
CREATE TABLE LteUnitListItem(MrBtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   primaryConnection varchar(20),
   serNum VARCHAR(50) DEFAULT "-",
   prodCode VARCHAR(20),
...
CREATE TABLE mrbtsHwList(mrbtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    prodCode VARCHAR(50) NOT NULL,
    serNum VARCHAR(50) NOT NULL,
    FOREIGN KEY (mrbtsInd) REFERENCES mrbts(Ind));

CREATE TABLE lnbts(MrBtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    Id DOUBLE NOT NULL,
    Ind DOUBLE PRIMARY KEY,
    SwVersion VARCHAR(10),
...
CREATE TABLE lncel(LnBtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   ind DOUBLE PRIMARY KEY,
   id DOUBLE NOT NULL,
   SwVersion VARCHAR(10),
   ...
   Tac INT,
   pMax FLOAT,
   FOREIGN KEY (LnBtsInd) REFERENCES lnbts(Ind));
...
CREATE TABLE Unit(ftmInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    id INT NOT NULL,
    unitTypeActual VARCHAR(30) DEFAULT "-",
    unitTypeExpected VARCHAR(20) DEFAULT "-",
    FOREIGN KEY (ftmInd) REFERENCES ftm(ind));

CREATE TABLE ipno(FtmInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   ind DOUBLE PRIMARY KEY,
   id DOUBLE NOT NULL,
...
CREATE TABLE ieif(IpnoInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   ...
   ind DOUBLE PRIMARY KEY,
   FOREIGN KEY (IpnoInd) REFERENCES ipno(ind));

CREATE TABLE ivif(IeifInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   ind DOUBLE PRIMARY KEY,
   id DOUBLE NOT NULL,
   localIpAddr VARCHAR(20),
   ...
   vlanId INT,
   FOREIGN KEY (IeifInd) REFERENCES ieif(ind));


CREATE TABLE iprt (IpnoInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    ind DOUBLE PRIMARY KEY,
    id DOUBLE NOT NULL,
    FOREIGN KEY (IpnoInd) REFERENCES ipno(ind));

CREATE TABLE StaticRoute(IprtInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   ind DOUBLE PRIMARY KEY,
   bfdId INT,
   ...
   netmask VARCHAR(20),
   preference INT,
   FOREIGN KEY (IprtInd) REFERENCES iprt(ind));


CREATE TABLE lnmme(LnBtsInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   ind DOUBLE PRIMARY KEY,
   id DOUBLE NOT NULL,
...
CREATE TABLE accMmePlmnsList(MmeInd DOUBLE NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
   mcc INT,
   mnc VARCHAR(10),
   FOREIGN KEY(MmeInd) REFERENCES lnmme(ind));
...
CREATE TABLE zwoi_bsc(ind INT PRIMARY KEY,
   file_uuid VARCHAR(40) DEFAULT "-",
...
CREATE TABLE zwos_bsc(ind INT PRIMARY KEY,
    parClass INT NOT NULL,
    identifier INT NOT NULL,
    nameOfParameter VARCHAR(80));

CREATE TABLE zwoi_rnc(ind INT PRIMARY KEY,
   file_uuid VARCHAR(40) DEFAULT "-",
    parClass INT NOT NULL,
    identifier INT NOT NULL,
    nameOfParameter VARCHAR(80));

CREATE TABLE zwos_rnc(ind INT PRIMARY KEY,
   file_uuid VARCHAR(40) DEFAULT "-",
    parClass INT NOT NULL,
    identifier INT NOT NULL,
    nameOfParameter VARCHAR(80));

CREATE TABLE bsc2zwoi(bscCnumber INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    zwoiInd INT NOT NULL,
    value VARCHAR(20),
    changePossibility VARCHAR(20),
    FOREIGN KEY (bscCnumber) REFERENCES bsc(cnumber),
    FOREIGN KEY (zwoiInd) REFERENCES zwoi_bsc(ind));
...
CREATE TABLE rnc2zwoi(rncCnumber INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    ...
    value VARCHAR(20),
    changePossibility VARCHAR(20),
    FOREIGN KEY (rncCnumber) REFERENCES rnc(cnumber),
    FOREIGN KEY (zwoiInd) REFERENCES zwoi_rnc(ind));


CREATE TABLE bsc2zwos(bscCnumber INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    zwoiInd INT NOT NULL,
    activationStatus VARCHAR(20),
    FOREIGN KEY (bscCnumber) REFERENCES bsc(cnumber),
    FOREIGN KEY (zwoiInd) REFERENCES zwos_bsc(ind));

CREATE TABLE rnc2zwos(rncCnumber INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    zwoiInd INT NOT NULL,
    activationStatus VARCHAR(20),
    FOREIGN KEY (rncCnumber) REFERENCES rnc(cnumber),
    FOREIGN KEY (zwoiInd) REFERENCES zwos_rnc(ind));

CREATE TABLE spc2name(cust INT NOT NULL,
   file_uuid VARCHAR(40) DEFAULT "-",
    name VARCHAR(40) DEFAULT "-",
    spc INT NOT NULL);
        
CREATE TABLE fns(customer_fk INT NOT NULL,	
   file_uuid VARCHAR(40) DEFAULT "-",		   
   name VARCHAR(20),
   spc INT DEFAULT NULL,
   type VARCHAR(10),
   ...
   swver VARCHAR(10),   
   state VARCHAR(10),
   FOREIGN KEY (customer_fk) REFERENCES cliente(id));
   
CREATE TABLE licence_fns (fea_code INT PRIMARY KEY,
   file_uuid VARCHAR(40) DEFAULT "-",
   fea_name VARCHAR(50));

CREATE TABLE fns_to_licence(id DOUBLE PRIMARY KEY,
   file_uuid VARCHAR(40) DEFAULT "-",
   cnumber_fk INT NOT NULL,
   fea_code_fk INT NOT NULL,
   capacity VARCHAR(10) NOT NULL,
   lk_usage VARCHAR(10) DEFAULT 'ON',
   FOREIGN KEY(cnumber_fk) REFERENCES fns(cnumber),
   FOREIGN KEY(fea_code_fk) REFERENCES licence_fns(fea_code));
...
CREATE TABLE fns_lk_file(filename VARCHAR(30),
   ...
   featurename VARCHAR(200),
   fea_code INT NOT NULL,
   FOREIGN KEY(targetid) REFERENCES fns(cnumber),
   FOREIGN KEY(fea_code) REFERENCES licence_fns(fea_code));    
   
CREATE TABLE units_fns(id INT, 
   file_uuid VARCHAR(40) DEFAULT "-",
   type VARCHAR(15),
   state VARCHAR(10),
   main_piu VARCHAR(15),
   memory INT DEFAULT -1,
   cnumber INT NOT NULL,
   FOREIGN KEY(cnumber) REFERENCES fns(cnumber));

CREATE TABLE plugin_units_fns(id INT, 
   file_uuid VARCHAR(40) DEFAULT "-",
   type VARCHAR(15),
   unit_type VARCHAR(15),
   rack VARCHAR(20) DEFAULT "-",
...
CREATE TABLE fns_application(target_id INT, 
   file_uuid VARCHAR(40) DEFAULT "-",
   ...
   FOREIGN KEY(target_id) REFERENCES fns(cnumber));   
      
CREATE TABLE fns_enb(target_id INT, 
   file_uuid VARCHAR(40) DEFAULT "-",
   ip VARCHAR(20),
   id VARCHAR(20),
   mcc VARCHAR(20),
...
CREATE TABLE fns_rnc(target_id INT, 
   file_uuid VARCHAR(40) DEFAULT "-",
   name VARCHAR(50),
   id VARCHAR(20),
   mcc VARCHAR(20),
...
CREATE TABLE bsc_prfile(target_id INT,
   file_uuid VARCHAR(40) DEFAULT "-",
   ...
   FOREIGN KEY(target_id) REFERENCES bsc(cnumber));

CREATE TABLE rnc_prfile(target_id INT,
   file_uuid VARCHAR(40) DEFAULT "-",
   parameter_class VARCHAR(10),
   parameter_name VARCHAR(100),
   identifier VARCHAR(15),
   ...
   value VARCHAR(15),
   change_possibility VARCHAR(10),
   FOREIGN KEY(target_id) REFERENCES rnc(cnumber));

CREATE TABLE fns_prfile(target_id INT,
   file_uuid VARCHAR(40) DEFAULT "-",
   parameter_class VARCHAR(10),
   parameter_name VARCHAR(100),
   identifier VARCHAR(15),
...
CREATE TABLE bsc_fifile(target_id INT,
   file_uuid VARCHAR(40) DEFAULT "-",
   parameter_class VARCHAR(10),
   parameter_name VARCHAR(100),
   identifier VARCHAR(15),
...
CREATE TABLE rnc_fifile(target_id INT,
   file_uuid VARCHAR(40) DEFAULT "-",
   parameter_class VARCHAR(10),
   parameter_name VARCHAR(100),
   identifier VARCHAR(15),
...
CREATE TABLE fns_fifile(target_id INT,
   file_uuid VARCHAR(40) DEFAULT "-",
   parameter_class VARCHAR(10),
   parameter_name VARCHAR(100),
   identifier VARCHAR(15),
...
CREATE TABLE fns_plmn(target_id INT,
   file_uuid VARCHAR(40) DEFAULT "-",
...
CREATE TABLE fns_plmn_parameter(plmn_id VARCHAR(80),   
   ...
   value VARCHAR(200),
   FOREIGN KEY(plmn_id) REFERENCES fns_plmn(id));
