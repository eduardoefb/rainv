...
class fns:	
	def __init__(self, ip, tn, name, logdir):
		...
		try:
			...
			inf = []
			output_log_name = "FNS_Info.log"
			expected_command_finish = "COMMAND EXECUTED"
			_timeout = 1800
			inf.append([tn, "ZKAI:;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZKAO;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZE6I:;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZE6L:;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZFWI:PGI=;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZFWI:PAPU=;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZFWO:GBU=0&&16;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZEJL:NSEI=0&&65535;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZFUI;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZQRI:;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZOYI::A;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZNRI:NA1;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZNSI:NA1;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZNFI:NA1:A;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZOCI:;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZOCJ:;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZOYO:;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZNNI:;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZE5I;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZW7I:FEA,FULL:FSTATE=ON,;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])										
			send_dx_command_log_b(inf)
...
class sgsn:
	...
	def __init__(self, ip, tn, name, logdir):
		...
		try:
			...
			inf.append([tn, "ZFWI:PGI=;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZFWI:PAPU=;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZFWO:PAPU=0&&16;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZEJL:NSEI=0&&65535;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZFUI;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZQRI:;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
			inf.append([tn, "ZOYI::A;", workdir + os.sep + output_log_name, expected_command_finish, name, _timeout])
