...
<html itemscope="" itemtype="http://schema.org/WebPage" lang="en-US">
   ...
   <body>
      ...
      ?>
      <a href="index.php?op=ra"><img src="../eme/img/icon/back.png" title="Back" height="36"></a>
      &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
      <a href="logs.php?op=ra"><img src="../eme/img/icon/log.png" title="Show execution logs" height="34"></a>
      <frame1>
